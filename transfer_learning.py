...
keras.utils.plot_model(
    model, to_file='./plots/transfer_learning_architecture.png', show_shapes=True)
...
plot_history(history,name='transfer_learning')
...
matrix = plot_confusion_matrix(test_labels, np.argmax(predictions, axis=1),name='transfer_learning')

plot_fractional_incorrect_misclassifications(matrix,name='transfer_learning')
