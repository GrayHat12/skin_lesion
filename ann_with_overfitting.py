...
# faster than cnn to train, 54% accuracy
...
def plot_fractional_incorrect_misclassifications(confusion_matrix):
    ...
    fig.savefig(
        './plots/ann_with_overfitting_fractional_incorrect_misclassifications.png')
    fig.show()
...
def plot_history(history):
    ...
    fig.savefig('./plots/ann_with_overfitting_history.png')
...
def plot_confusion_matrix(y_true, y_pred):
    ...
    fig.savefig('./plots/ann_with_overfitting_confusion_matrix.png')
    fig.show()
    return matrix
...
if __name__ == '__main__':
    ...
    keras.utils.plot_model(
        model, to_file='./plots/ann_with_overfitting_architecture.png', show_shapes=True)
    ...
    model.save('ann_with_overfitting_model')
